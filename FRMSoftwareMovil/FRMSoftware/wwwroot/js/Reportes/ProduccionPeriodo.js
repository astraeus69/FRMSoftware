window.generarGraficaProduccionPeriodo = function (idCanvas, labels, values, colorIndex) {
...
function descargarPDF_ProduccionPeriodo() {
    ...
    if (doc.autoTable) {
        ...
        doc.setFontSize(16);
        doc.setFont("helvetica", "bold");
        doc.text("Reporte de producción por periodo", doc.internal.pageSize.width / 2, 35, { align: "center" });
...
function descargarExcel_ProduccionPeriodo() {
