function descargarPDF_Empleados() {
    ...
    if (doc.autoTable) {
        ...
        doc.setFontSize(16);
        doc.setFont("helvetica", "bold");
        doc.text("Catálogo de empleados", doc.internal.pageSize.width / 2, 35, { align: "center" });
        ...
        doc.save("catalogo_empleados.pdf");
    } else {
        alert("jsPDF AutoTable no está disponible");
    }
}

function descargarExcel_Empleados() {
    const tabla = document.querySelector(".table");
